...
Function Install-DotnetCLI {
    ...
    if ($Force -or -not (Test-Path $cli.DotNetExe)) {
        ...
        Write-Host "$DotNetInstall -InstallDir $($cli.Root) -Version $($cli.Version) -Architecture $arch"

        & $DotNetInstall -InstallDir $cli.Root -Version $cli.Version -Architecture $arch
    }
